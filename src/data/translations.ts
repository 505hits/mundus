...
export const translations = {
    en: {
        nav: {
            ...
            features: "Features",
            contact: "Contact",
            book: "Book my first lesson for free",
            needHelp: "Need help?",
        ...
        howItWorks: {
            ...
            titleStart: "How it",
            titleEnd: "works",
            subtitle: "Get started in minutes — choose your path, learn at your pace, and see real progress.",
            steps: [
                {
                    number: "01",
        ...
        contact: {
            ...
            subtitle: "Whether you're ready to start learning or just have a few questions, we're here to help you every step of the way.",
        ...
        footer: {
            ...
            copyright: "© 2024 Mundus. All rights reserved."
        }
    },
    sk: {
        nav: {
            ...
            features: "Výhody",
            contact: "Kontakt",
            book: "Rezervovať prvú lekciu zdarma",
        ...
        howItWorks: {
            ...
            titleStart: "Ako to",
            titleEnd: "funguje",
            subtitle: "Začnite v priebehu pár minút — vyberte si cestu, učte sa vlastným tempom a vidíte skutočný pokrok.",
            steps: [
                {
                    number: "01",
        ...
        features: {
            label: "Prečo Mundus",
            titleStart: "Všetko čo potrebujete na",
            titleEnd: "úspech",
        ...
        contact: {
            ...
            titleStart: "Začnime",
            titleEnd: "konverzáciu",
            subtitle: "Či už ste pripravení začať sa učiť alebo máte len pár otázok, sme tu aby sme vám pomohli na každom kroku.",
            infoTitle: "Kontaktné info",
            emailLabel: "Napíšte nám",
            callLabel: "Zavolajte nám",
            visitLabel: "Navštívte nás",
            formTitle: "Pošlite nám správu",
            formSubtitle: "Vyplňte formulár nižšie a ozveme sa vám do 24 hodín.",
            firstName: "Meno",
            lastName: "Priezvisko",
            ...
            placeholders: {
                ...
                message: "Napíšte nám ako vám môžeme pomôcť..."
            }
        },
        footer: {
            ...
            copyright: "© 2024 Mundus. Všetky práva vyhradené."
        }
    }
};
